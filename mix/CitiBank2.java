class CitiBank2 
{
	...
	public static CitiBank2 createAcc(String Acc_Name, String Acc_Number, String Acc_Type, int pin)
	{
		CitiBank2 obj = new CitiBank2();
		obj.Acc_Name = Acc_Name;
		obj.Acc_Number = Acc_Number;
		obj.Acc_Type = Acc_Type.toUpperCase();
		obj.pin = pin;
